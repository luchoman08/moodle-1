 ...
 * */
       ...
       $choices = array(UU_USER_ADD_UPDATE => get_string('uuoptype_addupdate', 'tool_uploaduser'),
						 UU_USER_ADDNEW     => get_string('uuoptype_addnew', 'tool_uploaduser'),
                         UU_USER_ADDINC     => get_string('uuoptype_addinc', 'tool_uploaduser'),
                         UU_USER_UPDATE     => get_string('uuoptype_update', 'tool_uploaduser'));
